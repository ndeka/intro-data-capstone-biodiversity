...
print "Pvalue for Mammal vs Bird is :", pval

contingency2 = [[30,146], [5,73]]
chi2, pval_reptile_mammal, dof2, expected2 = chi2_contingency(contingency2)

print "Pvalue for Mammal vs Reptile is :", pval_reptile_mammal